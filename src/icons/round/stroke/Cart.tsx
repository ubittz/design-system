...
export const Cart = createIcon(
  <>
    ...
    />
    <path
      d='M5.00158 6.01L21 6L19.3491 13.43C19.149 14.35 18.3286 15 17.3881 15H8.61348C7.67299 15 6.85255 14.35 6.65245 13.43L5.00158 6.01ZM5.00158 6.01V6L4.4613 4.37C4.19115 3.55 3.42075 3 2.55029 3H2'
      stroke='currentColor'
      strokeLinecap='round'
      strokeLinejoin='round'
    />
