/**
 * @ubittz/design-system Tailwind CSS v3 Preset (ESM)
 *
 * Usage (tailwind.config.ts):
 *   import ubittzPreset from '@ubittz/design-system/tailwind-preset';
 *   export default { presets: [ubittzPreset], ... };
 */

const shades = [50, 100, 200, 300, 400, 500, 600, 700, 800, 900];

function colorFamily(name, extra = []) {
  const all = [...extra, ...shades];
  return Object.fromEntries(all.map((s) => [s, `var(--color-${name}-${s})`]));
}
